...
def Recognize_Digit():
    ...
    for cnt in contours:
         ...
         #cropping out the digit from thr image correspondhing to the current contours in the for loop
         digit=th[y:y + h, x:x + w]

         #Resizing that digit to (18,18)
         resized_digit=cv2.resize(digit,(18,18))

         #padding the didgit with 5 pixels of black color (zeros) in each side to finally to produce the image of (28,28) 
